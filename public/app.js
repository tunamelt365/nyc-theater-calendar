const TRIVIA = [
  ...
  "Jim Carrey's Grinch makeup took 2.5 hours to apply every single day. He had to be coached by a Navy SEAL on how to endure discomfort just to make it through filming.",
  ...
  "The horses in Monty Python and the Holy Grail were replaced with coconuts because the production couldn't afford real ones. That bit became more famous than anything else in the movie.",
  ...
  "The Cowardly Lion's costume in The Wizard of Oz was made from real lion hide and weighed over 90 pounds. The actor, Bert Lahr, was completely drenched in sweat by the end of every single scene.",
  "Pixar hid \"A113\" — the number of the animation classroom at CalArts where many Pixar founders studied — in every single one of their films.",
  "Buzz Lightyear was almost named Lunar Larry.",
  "The Matrix's iconic green code was created by digitizing sushi recipes from the designer's wife's cookbooks.",
  "The 'snow' falling in The Wizard of Oz's poppy field scene was actually asbestos.",
  "Christian Bale based Patrick Bateman's entire look and demeanor in American Psycho on Tom Cruise.",
  "Kubrick fed Jack Nicholson only cheese sandwiches on The Shining set every day, knowing he hated them, to keep him in a state of low-grade rage.",
  "The Pulp Fiction overdose revival scene was filmed in reverse — they shot the needle being pulled out and played it backwards.",
  "Charlie Sheen stayed awake for 48 hours straight to look authentically intoxicated for his single scene in Ferris Bueller's Day Off.",
  "The animators designing Flynn Rider in Tangled held official 'hot guy meetings' where they studied photos of male celebrities to nail his look.",
  "Anthony Hopkins reportedly never blinks during any of his scenes as Hannibal Lecter. Watch it back — it's unsettling.",
  "During production of Titanic, someone spiked the crew's clam chowder with PCP. Over 50 cast and crew members were hospitalized, including James Cameron.",
  "Nicolas Cage ate a real cockroach on camera for Vampire's Kiss. He said he felt it was necessary for the character. The crew was horrified.",
  "Keanu Reeves gave away roughly $75 million of his Matrix sequels earnings to the costume and special effects teams, saying they deserved it more.",
  "Paranormal Activity was made for $15,000. It grossed $193 million worldwide.",
];
