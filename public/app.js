const TRIVIA = [
  ...
  "Arnold Schwarzenegger pushed to change 'I'll come back' to 'I'll be back' in The Terminator because he felt 'I'll' was too hard to say with his accent. The studio thought it sounded weird.",
  ...
  "The original ending of Pretty Woman had Vivian getting kicked out of the car with cash and the film ending bleakly on the street. Disney bought the script and rewrote it as a fairy tale.",
  "Clint Eastwood has directed and produced dozens of films but has never watched any of them after they were finished.",
  "In Home Alone, the gangster film Kevin watches and uses to terrorize people — 'Angels with Filthy Souls' — is not a real movie. It was made entirely for Home Alone.",
